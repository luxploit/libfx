#include <libfx/fxCrypto/fxCipher/fxCipherXTEA.hpp>

bool fxCipherXTEA::init(const std::uint8_t* key, const std::size_t keylen) noexcept {
	if (keylen != 16) {
...
[[nodiscard]] std::vector<std::uint8_t> fxCipherXTEA::encrypt(const std::uint8_t* iv, const std::uint8_t* plaintext, const std::size_t pt_len) noexcept {
...
[[nodiscard]] std::vector<std::uint8_t> fxCipherXTEA::decrypt(const std::uint8_t* iv, const std::uint8_t* ciphertext, const std::size_t ct_len) noexcept {
