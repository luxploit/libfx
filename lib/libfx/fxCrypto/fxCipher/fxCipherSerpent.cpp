#include <libfx/fxCrypto/fxCipher/fxCipherSerpent.hpp>

bool fxCipherSerpent::init(const std::uint8_t* key, const std::size_t keylen) noexcept {
...
[[nodiscard]] std::vector<std::uint8_t> fxCipherSerpent::encrypt(const std::uint8_t* iv, const std::uint8_t* plaintext, const std::size_t pt_len) noexcept {
...
[[nodiscard]] std::vector<std::uint8_t> fxCipherSerpent::decrypt(const std::uint8_t* iv, const std::uint8_t* ciphertext, const std::size_t ct_len) noexcept {
